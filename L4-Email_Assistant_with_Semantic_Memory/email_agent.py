...
if __name__ == "__main__":
    ...
    response = agent.email_agent.invoke({"email_input": email_input}, config=config)
    print(f"=================================================================================================")
    ...
    # Use new config here
    config = {"configurable": {"langgraph_user_id": "green"}}
    email_input = {
    ...
    print(f"namespaces in store: \n{agent.main_agent.store.list_namespaces()}")
    search_result = agent.main_agent.store.search(('email_assistant', 'lance', 'collection'))
    print(f"search result:\n {search_result}")

    search_result = agent.main_agent.store.search(('email_assistant', 'green', 'collection'), query="jim")
    print(f"search result:\n {search_result}")
